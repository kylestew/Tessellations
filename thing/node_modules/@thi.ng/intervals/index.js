...
export function interval(l, r, lopen, ropen) {
 ...
 * @param open -
 */
export const withMin = (min, open = false) => new Interval(min, Infinity, open, false);
/**
 ...
 * @param open -
 */
export const withMax = (max, open = false) => new Interval(-Infinity, max, false, open);
/**
 ...
 * @param max
 */
export const open = (min, max) => new Interval(min, max, true, true);
/**
 ...
 * @param max
 */
export const openClosed = (min, max) => new Interval(min, max, true, false);
/**
 ...
 * @param max
 */
export const closedOpen = (min, max) => new Interval(min, max, false, true);
/**
 ...
 * @param max
 */
export const closed = (min, max) => new Interval(min, max, false, false);
/**
 ...
 * @param step -
 */
export const values = (i, step) => samples(i, Math.floor(i.size / step + 1));
/**
 ...
 * @param i -
 */
export const isEmpty = (i) => i.l >= i.r;
/**
 ...
 * @param x -
 */
export const isBefore = (i, x) => x instanceof Interval
    ? i.ropen || x.lopen
        ? i.r <= x.l
        : i.r < x.l
    : i.ropen
 ...
 * @param x -
 */
export const isAfter = (i, x) => x instanceof Interval
    ? i.lopen || x.ropen
        ? i.l >= x.r
        : i.l > x.r
    : i.ropen
 ...
 * @param x -
 */
export const contains = (i, x) => (i.lopen ? x > i.l : x >= i.l) && (i.ropen ? x < i.r : x <= i.r);
export const centroid = (i) => (i.l + i.r) / 2;
/**
 ...
 * @param x -
 */
export const include = (i, x) => isAfter(i, x)
 ...
 * @param b -
 */
export const distance = (a, b) => overlaps(a, b) ? 0 : a.l < b.l ? b.l - a.r : a.l - b.r;
/**
 ...
 * @param fn -
 */
export const transform = (i, fn) => new Interval(fn(i.l), fn(i.r), i.lopen, i.ropen);
/**
 ...
 * @param b -
 */
export const classify = (a, b) => a.equiv(b)
    ? Classifier.EQUIV
    : isBefore(a, b)
 ...
 * @param b -
 */
export const overlaps = (a, b) => classify(a, b) >= Classifier.EQUIV;
/**
 ...
 * @param eps -
 */
export const min = (i, x, eps = DEFAULT_EPS) => i.ropen ? (x >= i.r ? i.r - eps : x) : x > i.r ? i.r : x;
/**
 ...
 * @param eps -
 */
export const max = (i, x, eps = DEFAULT_EPS) => i.lopen ? (x <= i.l ? i.l + eps : x) : x < i.l ? i.l : x;
/**
 ...
 * @param eps -
 */
export const clamp = (i, x, eps = DEFAULT_EPS) => min(i, max(i, x, eps), eps);
/** @internal */
