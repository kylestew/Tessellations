import { TAU, PI, INV_HALF_PI, RAD2DEG, DEG2RAD, HALF_PI } from './api.js';
...
export { absInnerAngle, absTheta, angleDist, atan2Abs, cossin, cot, csc, deg, fastCos, fastSin, loc, normCos, quadrant, rad, sec, sincos };
