...
export { absMax, absMin, clamp, clamp0, clamp01, clamp05, clamp11, foldback, inOpenRange, inRange, max2id, max3id, max4id, min2id, min3id, min4id, minNonZero2, minNonZero3, sclamp, smax, smin, wrap, wrap01, wrap11, wrapOnce };
